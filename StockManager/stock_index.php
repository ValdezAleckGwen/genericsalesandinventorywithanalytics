...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>NARCI - Stock Transfer</title>
    ...
    <div class="flex-container">
       <div class="flex-items">
         <div class="table-title">
          <h6 style="display: inline-block; float: right; color: #363636; padding: 10px 40px;"><b>STOCK TRANSFER</b><br>ST ID: ST1101<br><u>04/10/2022</u> - <u>04/17/2022</u></h6>
          <div class="form-style-2">
          <div class="form-style-2-heading">STOCK TRANSFER</div>
          <form action="" method="post">
          <table class="table-fill2">
            <tr>
              <thead>
                <th class="text-center">ORIGIN ADDRESS</th>
                <th class="text-center">DESTINATION ADRESS</th>
            ...
            <table class="table-fill">
              ...
              <button type="button" class="btn btn-primary" style="float: right;font-size: 16px; font-weight: 700;"><i class="fa-solid fa-circle-plus"></i> Add Item</button><br>          
          </div>
          </form>
