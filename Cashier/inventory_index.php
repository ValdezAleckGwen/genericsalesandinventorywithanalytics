...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>NARCI - Inventory Cashier</title>
...
<!-- Start of Menu Proper -->
      <div class="menu">
		...
		<!-- Inventory-->
        <div class="item"><a href="inventory_indexs.php"><i class="fa-regular fa-warehouse"></i>Inventory</a></div>
       

        <!-- Orders-->
        <div class="item"><a href="orders_indexs.php"><i class="fa-regular fa-cart-shopping"></i>Orders</a></div>

        <!-- Point of sales-->
        <div class="item"><a href="pos_indexs.php"><i class="fa-regular fa-calculator"></i>Point of Sales</a></div>

        <!-- Logout -->
        <div class="item"><a href="../admin/logins.php"><i class="fa-regular fa-arrow-right-from-bracket"></i>Logout</a></div>
  ...
  <div class="flex-container">
     <div class="flex-items">
       <div class="table-title">
        ...
        <td class="text-center"><span class="badge badge-pill badge-success" style="width: 80px;">In Stock</span>
        </tr>
