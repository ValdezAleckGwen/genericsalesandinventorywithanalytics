...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>NARCI - Add Category</title>
  ...
  <div class="flex-container">
     <div class="flex-items">
       <div class="table-title">
        ...
        <div class="form-style-2-heading">ADD CATEGORY</div>
        <form action="" method="post">
        <label for="field1"><span>Category ID<span class="required"></span></span>
          <input type="text" class="input-field" name="categoryid" value="<?php echo $number; ?>" disabled=""></label>
        <label for="field1"><span>Category Name<span class="required">*</span></span><input type="text" class="input-field" name="categoryname" value="" required /></label>
        <div align="left">
           <!--  <button type="submit" class="btn btn-primary" style="font-size: 16px; font-weight: 700;"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add</button> -->
