...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>NARCI - Edit Category</title>
  ...
  <div class="flex-container">
     <div class="flex-items">
       <div class="table-title">
        ...
        <div class="form-style-2-heading">EDIT BRANCH</div>
        <form action="" method="post">
        <label for="field4"><span>Branch Name<span class="required">*</span></span><select name="field4" class="select-field">
        ...
        <option value="Las Pinas Branch">Las Pinas Branch</option>
        <option value="Mandaluyong Branch">Mandaluyong Branch</option>
        </select></label>
        <label for="field3"><span>New Branch Name<span class="required">*</span></span><input type="text" class="input-field" name="field3" value=""/></label>
        <label for="field3"><span>New Address<span class="required">*</span></span><input type="text" class="input-field" name="field3" value=""/></label>
        <label for="field3"><span>New Contact Number<span class="required">*</span></span><input type="text" class="input-field" name="field3" value=""/></label>
