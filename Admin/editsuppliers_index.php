  ...
  <div class="flex-container">
     <div class="flex-items">
       <div class="table-title">
        ...
        <div class="form-style-2-heading">EDIT SUPPLIER</div>
        <form action="" method="post">
        <label for="field4"><span>Supplier Name<span class="required">*</span></span><select name="field4" class="select-field">
        <option value="EasyCo.">Jon Geoffrey</option>
        <option value="ClothingCure">Kate Lesley</option>
        <option value="LARA">Sofia Theresa</option>
        <option value="ShopThrifty">Jessa Cristobal</option>
        <option value="KirstenClothing">Kirsten Santos</option>
        <option value="AMARAH">Amarah Kate</option>
        <option value="MonicaBags">Monica Grace</option>
        </select></label>
        <label for="field2"><span>Contact Person<span class="required">*</span></span><input type="text" class="input-field" name="field2" value="" /></label>
        <label for="field2"><span>Email<span class="required">*</span></span><input type="text" class="input-field" name="field2" value="" /></label>
        <label for="field2"><span>Contact Number<span class="required">*</span></span><input type="text" class="input-field" name="field2" value="" /></label>
        <div align="left">
