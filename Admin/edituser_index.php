  ...
  <div class="flex-container">
     <div class="flex-items">
       <div class="table-title">
        ...
        <div class="form-style-2-heading">EDIT USERS</div>
        <form action="" method="post">

        <label for="field4"><span>Name<span class="required">*</span></span><select name="field4" class="select-field">
        <option value="User1">Richmonde Toledo</option>
        <option value="User2">Jeremy Langcay</option>
        </select></label>
        <label for="field1"><span>New Username<span class="required">*</span></span><input type="text" class="input-field" name="field1" value="" /></label>      
        <label for="field4"><span>Role<span class="required">*</span></span><select name="field4" class="select-field">
        <option value="Admin">Admin</option>
        <option value="Cashier">Cashier</option>
        </select></label>
        <label for="field1"><span>Password<span class="required">*</span></span><input type="password" class="input-field" name="field1" value="" /></label>
        <label for="field1"><span>Mobile Number<span class="required">*</span></span><input type="password" class="input-field" name="field1" value="" /></label>     
