  ...
  <div class="flex-container">
     <div class="flex-items">
       <div class="table-title">
        ...
        <div class="form-style-2-heading">EDIT CATEGORY</div>
        <form action="" method="post">
        <label for="field4"><span>Category Name<span class="required">*</span></span><select name="field4" class="select-field">
        ...
        <label for="field3"><span>New Category Name<span class="required">*</span></span><input type="text" class="input-field" name="field3" value=""/></label>
