     ...
     <div class="flex-items">
       <div class="table-title">
        ...
        <div style="display: inline;">
          <a href="salesreport.php"><button type="button" class="btn btn-dark" style="font-size: 16px; font-weight: 700;"><i class="fa-solid fa-print"></i> Print</button></a>
        </div>
