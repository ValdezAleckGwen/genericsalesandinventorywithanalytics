...
if($total_data > 0)
{
  foreach($result as $row)
  {
    ...
    <tr>
      ...
      <td class="text-center" style="border: 1px solid;"> <button class="btn btn-info" id="#" data-id="#"><i class="fa-solid fa-pen-to-square"> </i></button> <button class="delete btn btn-danger" id="del_'.$row["branchid"].'" data-id="'.$row["branchid"].'"><i class="fa-solid fa-circle-minus" ></i></button></td>
    </tr>
    ';
  }
}
