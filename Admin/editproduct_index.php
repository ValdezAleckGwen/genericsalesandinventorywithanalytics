...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>NARCI - Edit Products</title>
    ...
    <div class="flex-container">
       <div class="flex-items">
         <div class="table-title">
          ...
          <div class="form-style-2-heading">EDIT PRODUCTS</div>
          <form action="" method="post">
          <label for="field1"><span>Product Name<span class="required">*</span></span><input type="text" class="input-field" name="field1" value="" /></label>
          <label for="field4"><span>Category<span class="required">*</span></span><select name="field4" class="select-field">
          <option value="Bag">Bag</option>
          <option value="Tops">Tops</option>
          <option value="Coordinates">Coordinates</option>
          <option value="Bottoms">Bottoms</option>
          <option value="Bottoms">Denim</option>
          <option value="Bottoms">Dress</option>
          </select></label>
          <label for="field4"><span>Supplier</span><select name="field4" class="select-field">
          <option value="Easy Co">Easy Co.</option>
          <option value="Clothing Cure">Clothing Cure</option>
          <option value="LARA">LARA</option>
          <option value="Shop Thrifty">Shop Thrifty</option>
          <option value="Kirsten Clothing">Kirsten Clothing</option>
          <option value="AMARAH">AMARAH</option>
          </select></label>

          <label for="field2"><span>Price (₱)<span class="required">*</span></span><input type="text" class="input-field" name="field2" value="" /></label>
          <label for="field2"><span>Markup Price (₱)<span class="required">*</span></span><input type="text" class="input-field" name="field2" value="" /></label>
