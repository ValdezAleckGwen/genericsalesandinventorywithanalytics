<?php 
  require_once '../actions/adddata.php';
  $number = createId('tblproducts');
  ...
  <div class="flex-container">
     <div class="flex-items">
       <div class="table-title">
        ...
        <div class="form-style-2-heading">ADD PRODUCTS</div>
        <form action="" method="post">
        <label for="field1"><span>Product ID:<span class="required">*</span></span><input type="text" class="input-field" name="productid" value="<?php echo $number;?>" disabled /></label>
        <label for="field1"><span>Product Name<span class="required">*</span></span><input type="text" class="input-field" name="productname" value="" /></label>
        <label for="field4"><span>Category<span class="required">*</span></span><select name="categoryid" class="select-field" required>
        ...
        <?php
          ...
          echo "<option id='".$supplier['id']."' value='".$supplier['id']."'>".$supplier['name']."</option>";
            }
        ?>
        </select>

        <label for="field2"><span>Price (₱)<span class="required">*</span></span><input type="number" class="input-field" name="price" value="" required/></label>
        <label for="field2"><span>Markup Price (₱)<span class="required">*</span></span><input type="number" class="input-field" name="markupprice" value="" required/></label>

        <div align="left">
          <button type="button" class="btn btn-primary" style="font-size: 16px; font-weight: 700;"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add</button>
